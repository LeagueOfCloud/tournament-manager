CREATE TABLE IF NOT EXISTS tournament_db.dreamdraft_match_scores (
    tournament_match_id VARCHAR(15) NOT NULL,
    player_id INT NOT NULL,
    score FLOAT NOT NULL,

    PRIMARY KEY (tournament_match_id, player_id),

    CONSTRAINT fk_ddms_match FOREIGN KEY (tournament_match_id) REFERENCES tournament_db.tournament_matches (tournament_match_id) ON DELETE CASCADE,
